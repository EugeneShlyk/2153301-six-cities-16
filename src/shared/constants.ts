...
export const CityMap = {
  ...
  Amsterdam: {name: CitiesName.Amsterdam, location: {latitude: 52.3676, longitude: 4.9041, zoom: 10}, slug: '/amsterdam'},
  Hamburg: {name: CitiesName.Hamburg, location: {latitude: 53.5488, longitude: 9.9872, zoom: 10}, slug: '/hamburg'},
  Dusseldorf: {name: CitiesName.Dusseldorf, location: {latitude: 51.2277, longitude: 6.7735, zoom: 10}, slug: '/dusseldorf'},
} as const;
